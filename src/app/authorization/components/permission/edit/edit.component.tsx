...
class EditComponent extends Component <IPropsPermission, IStatePermission> {
    ...
    handleSubmit = async (values: { name?: any; description?: any; active?: any; id?: any; }, setSubmitting: (isSubmitting: boolean) => void, resetForm: (nextState?: Partial<FormikState<{ name: any; description: any; active: any; }>> | undefined) => void) => {
        const {id} = this.props.params;
        values.id = id;
