...
class SearchComponent extends Component <IPropsPermissionUser, IStatePermissionUser> {
                        ...
                        <div className="form-header">
                            <div className=" "
                                ...
                                <div className="rs-select2--light rs-select2--md">
                                    <select onChange={this.onSortChange} className="js-select2" name="property">
                                ...
                                <div className="rs-select2--light rs-select2--md">
                                    <select onChange={this.onOrderChange} className="js-select2" name="property">
