                                          ...
                                          <nav>
                                              <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                                  <a className="nav-item nav-link active" id="custom-nav-info-tab"
                                                     data-toggle="tab"
                                                     href="src/app/components/authentication/reset-password/reset.password.component#custom-nav-info" role="tab" aria-controls="custom-nav-info"
                                                  ...
                                                  <a className="nav-item nav-link" id="custom-nav-address-tab"
                                                     data-toggle="tab"
                                                     href="src/app/components/authentication/reset-password/reset.password.component#custom-nav-address" role="tab"
                                                                  ...
                                                                  <div className="login-form">
                                                                      ...
                                                                      <div className="card"
                                                                          ...
                                                                          <div className="card-body">
                                                                              ...
                                                                              <button type="button"
                                                                                      onClick={(event) => this.props.navigate('../tionactiva')}
                                                                                      className="btn btn-link btn-sm">
                                                                                  <Trans
