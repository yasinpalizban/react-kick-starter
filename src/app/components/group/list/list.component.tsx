...
class ListComponent extends BasicListComponent <IPropsGroup, IStateGroup>{
    sortData = [
        {id: 'id', text: 'Id',},
        {id: 'name', text: 'Name',},
    ];
    ...
    onOpenModal = (event:any) => {
        ...
        this.setState({
            ...
            deleteId: id,
            deleteIndex: index,
            deleteItem: this.props.groupList.data![index].name
        });
        ...
        return (<>
            ...
            <div className="table-responsive table-responsive-data2">
                ...
                <table className="table table-data2">
                    ...
                    <tbody>
                    {
                        groupList?.data?.map((item, i:number) => {
            ...
            <div className="row mt-3">
                <div className="col-12 col-md-12 col-xs-12">
                    ...
                    <ReactPaginate
                        ...
                        pageCount={groupList.pager?.pageCount!}
