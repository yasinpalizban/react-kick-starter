...
function ListComponent(props: IProps) {
    ...
    const permissionGroupList: IResponseObject<IPermissionGroup[]> = useSelector((item: IReduxState) => item.permissionGroup);
    const dispatch = useDispatch();
    const columns: TableColumn<IPermissionGroup>[] = [
        {
            name: '#',
    ...
    const onOpenModal = (event: any) => {
        ...
        baseListHooks.setData({
            ...
            deleteId: id,
            deleteIndex: index,
            deleteItem: permissionGroupList.data![index].group
        });
    }
    ...
    const onSort = (selectedColumn: TableColumn<IPermissionGroup>, sortDirection: SortOrder) => {
    ...
    return (<>
        ...
        <div className="table-responsive table-responsive-data2">
            ...
            <DataTable
                columns={columns}
                data={permissionGroupList?.data!}
                pagination
                paginationServer
                paginationTotalRows={permissionGroupList.pager?.total!}
                paginationDefaultPage={permissionGroupList.pager?.pageCount!}
